...
public class ML {
    ...
    public static List<String> log_history = new ArrayList<>();
    ...
    public static void setUseLogApi(Boolean useLogApi) {
        ...
        ML.log(TAG, "ML.useLogApi = " + useLogApi);
    }
    public static void clear_history(){
        log_history.clear();
        ML.warn(TAG, "Log history cleared.");
    }
