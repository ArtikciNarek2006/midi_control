...
public class MidiPortWrapper {
    private final MidiDeviceInfo mInfo;
    ...
    private void updateString() {
        if (mInfo == null) {
            ...
            if (name == null) {
                name = mInfo.getProperties().getString(MidiDeviceInfo.PROPERTY_MANUFACTURER) + ", " + mInfo.getProperties().getString(MidiDeviceInfo.PROPERTY_PRODUCT);
            }
